...
function Searchbar() {
    return (
        <form className="mt-10 mx-auto max-w-xl py-2 px-6 rounded-full bg-gray-50 border flex focus-within:border-gray-300">
            <input type="text" placeholder="Search anything" className="bg-transparent w-full focus:outline-none pr-4 text-gray-400 font-semibold border-0 focus:ring-0 px-0 py-0" name="topic" />
